                    ...
                    <div style="margin-bottom: 10px;">
                        ...
                        <asp:Panel ID="PanelJie" runat="server">
                            <table class="tablelist" width="851" border="1" cellspacing="0" cellpadding="5">
                                ...
                                <tr>
                                    <td>借用日期</td>
                                    <td>
                                        <asp:TextBox ID="txt_JieDate" CssClass="dfinput" Width="120px" runat="server" onclick="WdatePicker({skin:'whyGreen'})"></asp:TextBox></td>
                                    <td>应还日期</td>
                                    <td>
                                        <asp:TextBox ID="txt_YingHuanDate" CssClass="dfinput" Width="120px" runat="server" onclick="WdatePicker({skin:'whyGreen'})"></asp:TextBox></td>
                                    <td>操作日期</td>
                                    <td>
                        ...
                        <asp:Panel ID="PanelHuan" runat="server">
                            <table class="tablelist" width="851" border="1" cellspacing="0" cellpadding="5">
                                <tr>
                                    <td>使用情况</td>
                                    <td><asp:DropDownList ID="ddl_UseQK" runat="server" Width="150" AutoPostBack="True" OnSelectedIndexChanged="ddl_Position2_SelectedIndexChanged"></asp:DropDownList></td>
                                    <td>归还日期</td>
                                    ...
                                    <td>归还操作日期</td>
                                    <td>
                                        <asp:Label ID="lbl_HuanOperateDate" CssClass="dfinput" runat="server" Text="" Width="150px"></asp:Label>
                                    </td>
                                    <td>归还操作员</td>
                                    <td>
                                        <asp:Label ID="lbl_HuanJBRUserKey" CssClass="dfinput" runat="server" Text="" Width="150px"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>归还备注</td>
                                    <td colspan="7">
                                        <asp:TextBox ID="txt_HuanRemark" runat="server" CssClass="dfinput" Width="800px"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td colspan="8">
