<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GZLApplyLeft.aspx.cs" Inherits="web.Application.GZL.GZLApplyLeft" %>
...
<body style="background:#f0f9fd;">
    ...
    <div class="lefttop"><span></span>工作申请</div>
    
    <dl class="leftmenu">
        
    <dd>
    <div class="title">
    <span><img src="/media/images/leftico01.png" /></span>采购管理
    </div>
    	<ul class="menuson">
        <li ><cite></cite><a href="/Application/GZL/CG/PurchaseApply.aspx" target="rightFrame">采购申请</a><i></i></li>
