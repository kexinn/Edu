<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseFormEdit.aspx.cs" Inherits="web.Application.GZL.CG.PurchaseFormEdit" %>
            ...
            <ItemTemplate>
                <tr>
                                    ...
                                    <td valign="top" width="45">
                                        <p class="MsoNormal">
                                            <span lang="EN-US">
                                                <o:p> <asp:LinkButton ID="lbEdit" CommandName="Edit" runat="server"><i class="ibtn">编辑</i></asp:LinkButton>&nbsp;</o:p>
                                            </span>
                                        </p>
                                    </td>
                                </tr>
            ...
            <EditItemTemplate>
                <tr>
                                    ...
                                    <td colspan="2" valign="top" width="113">
                                        <p class="MsoNormal">
                                            <span lang="EN-US">
                                                <o:p> <asp:TextBox ID="tbType" CssClass="dfinput" width="120px"  runat="server" Text='<%# Bind("type")%>' />
                                                   </o:p>
                                            </span>
                                        </p>
                                    </td>
                                    ...
                                    <td valign="top" width="57">
                                        <p class="MsoNormal">
                                            <span lang="EN-US">
                                                <o:p>
                                                    <asp:TextBox ID="tbPrice" runat="server"  CssClass="dfinput" width="80px" Text='<%# Bind("price")%>' />
                                                    </o:p>
                                            </span>
                                        </p>
                                    </td>
                    ...
                    <asp:TextBox ID="tbNumber" runat="server"  CssClass="dfinput" width="60px" Text='<%# Bind("number")%>' /></o:p>
                                            </span>
                                        </p>
                                    </td>
                                    <td colspan="2" valign="top" width="57">
                                    ...
                                    <td valign="top" width="45">
                                        <p class="MsoNormal">
                                            <span lang="EN-US">
                                                <o:p> 
                                                    <asp:LinkButton id="lbUpdate" CommandName="Update" runat="server"><i class="ibtn">更新</i></asp:LinkButton>
                    <asp:LinkButton id="lbCancel" CommandName="Cancel" runat="server"><i class="ibtn">取消</i></asp:LinkButton></o:p>
                                            </span>
                                        </p>
                                    </td>
                                </tr>
